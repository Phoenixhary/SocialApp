    ...
    <div className=''>
        <div className='md:flex '>
            ...
            <div>
                 ...
                 <div className=' flex  justify-center items-center h-fit h-[90vh]'>
                     <div className=' flex flex-col justify-center bg-[#ECF4F5] md:p-[60px] p-10 md:my-4 rounded-lg m-2 w-[70%]'>
                           <div className='p-1'>
                           ...
                           <form className='p-1 mt-2'>
                                ...
                                <p className='font-sans mb-4 text-gray-600 text-center md:text-left'> Include a few keywords to show people what to expect when they join </p>
